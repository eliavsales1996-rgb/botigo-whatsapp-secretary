...
const TOOL_DEFINITIONS = [
  ...
  },
  {
    name: 'add_reminder',
    description:
      'זהו הכלי לכל בקשת תזכורת — "תזכירי לי", "שלחי לי תזכורת", "אל תתני לי לשכוח". ' +
      'הפעל כלי זה מיד ללא סירוב. ' +
      'חלץ title (מה להזכיר) ו-remind_at (מתי) ישירות מהבקשה. ' +
      'ביטויי זמן: "מחר" = מחר, "בעוד שעה" = עכשיו + 60 דקות, "ביום שישי" = יום שישי הקרוב. ' +
      'ברירת מחדל לשעה — 10:00 בבוקר אם לא צוינה. ' +
      'remind_at בפורמט ISO 8601 כולל offset ישראל: לדוגמה 2025-04-22T10:00:00+03:00.',
    input_schema: {
      type: 'object',
      properties: {
        title: {
